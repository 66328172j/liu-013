 ...
 */
@TableName("t_am_rule")
@ApiModel(value = "TAmRule", description = "检验判废判据")
public class TAmRule implements Serializable {
    ...
    @ApiModelProperty(value = "判据编号")
    private String ruleCode;

    /** 判据名称 */
    @TableField("rule_name")
    @ApiModelProperty(value = "判据名称")
    private String ruleName;

    /** 轻微档上限(磨损量%) */
    @TableField("th1_max")
    @ApiModelProperty(value = "轻微档上限(磨损量%)")
    private BigDecimal th1Max;

    /** 关注档上限(磨损量%) */
    @TableField("th2_max")
    @ApiModelProperty(value = "关注档上限(磨损量%)")
    private BigDecimal th2Max;

    /** 判废档上限(磨损量%) */
    @TableField("th3_max")
    @ApiModelProperty(value = "判废档上限(磨损量%)")
    ...
    /** 判据状态 0启用 1停用 */
    @TableField("status")
    @ApiModelProperty(value = "判据状态 0启用 1停用")
